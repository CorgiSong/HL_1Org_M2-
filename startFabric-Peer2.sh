...
docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org1.example.com/msp" peer2.org1.example.com peer channel fetch config -o ec2-18-219-201-45.us-east-2.compute.amazonaws.com:7050 -c composerchannel
